...
*European Conference on Information Retrieval (ECIR)*, 2026 (*equal contribution*)
...
Worked on LLM fine-tuning for domain adaptation of neural translation models in low-resource settings. Applied fine-tuning techniques such as LoRA to effectively adapt LLMs to new tasks.  
